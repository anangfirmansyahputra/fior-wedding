  ...
  return (
    <Template>
      <div className="h-[80vh] items-center justify-center">
        <div className="relative h-1/2 w-full">
          ...
          <div className="relative z-[1] flex h-full flex-col items-center justify-center">
            <div className="mx-auto w-fit">
              <p className="cardo-regular text-4xl text-white">
                PORTFOLIO GALLERY
              </p>
              <div className="mx-auto mb-[30px] mt-[10px] h-[3px] w-[50%] bg-[#DBBEB8]" />
            </div>
            <p className="mx-auto max-w-[750px] text-center text-[20px] text-white">
        ...
        <div className="relative mx-[-100px] grid h-1/2 grid-cols-4 gap-[30px] bg-[#D1C7BE] py-[24px]">
